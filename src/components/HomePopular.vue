<template>
  <section class="mt-15 rounded-[23px] bg-primary-100 p-7/5">
    <div class="mt-0 -mr-3 ml-0 flex w-full flex-wrap">
        ...
        <div class="mt-0 -mr-3 -ml-3 flex flex-wrap">
          ...
          >
            <router-link
              ...
              tag="div"
              class="item group relative mb-7/5 block rounded-[23px] bg-secondary py-7/5 px-15px"
            >
              <!-- <div class="item group mb-7/5 rounded-[23px] bg-secondary py-7/5 px-15px"> -->
              <div class="relative mx-auto h-[200px] overflow-hidden rounded-[23px] lg:h-[138.45px] xl:w-[180px]">
                <img
                  class="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 rounded-23px"
              ...
              <ul class="absolute top-[15.5rem] right-0 pr-[15px] lg:top-48">
